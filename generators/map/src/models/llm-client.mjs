 ...
 * Shares ORCHESTRATOR_* env vars with the orchestrator package.
 */
...
export async function chat(messages, { temperature = 0.3, logStep = "orchestrator", requestTimeoutMs, responseFormatType } = {}) {
